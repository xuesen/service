...
{
    public partial class RcLog : DomainObject
    {
        ...
        public virtual int? ProcessInQty { get; set; }

        public virtual int? ProcessOutQty { get; set; }

        public virtual string ProcessInEmployee { get; set; }

        public virtual string ProcessOutEmployee { get; set; }

        public virtual string RcStatus { get; set; }
