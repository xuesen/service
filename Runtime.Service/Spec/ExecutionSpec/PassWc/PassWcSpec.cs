...
// {
//     public class BomMaterialPreparingCollectionSpec : BaseCollectionSpec
//     {
//         private IRepository<TerminalParts> _repTerminalParts;
//         public virtual string Wo { get; set; }
//         public virtual int TerminalId { get; set; }

//         public BomMaterialPreparingCollectionSpec(IRepository<TerminalParts> repTerminalParts)
//         {
//             _repTerminalParts = repTerminalParts;
//         }

//         public override int CollectSpecItem(int itemId, int? candidateId, object value, string editor)
//         {
