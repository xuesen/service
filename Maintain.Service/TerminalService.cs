...
{
    public partial class TerminalService : BaseMaintainService<STerminal, TerminalDTO>, ITerminalService
    {
        public TerminalService(IRepository<STerminal> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
