...
{
    public partial class ProcessTypeService : BaseMaintainService<SProcessType, ProcessTypeDTO>, IProcessTypeService
    {
        public ProcessTypeService(IRepository<SProcessType> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
