...
{
    public partial class ScrapReasonService : BaseMaintainService<SScrapreason, ScrapReasonDTO>, IScrapReasonService
    {
        public ScrapReasonService(IRepository<SScrapreason> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
