...
{
    public partial class ShiftGroupService : BaseMaintainService<SShiftGroup, ShiftGroupDTO>, IShiftGroupService
    {
        public ShiftGroupService(IRepository<SShiftGroup> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
