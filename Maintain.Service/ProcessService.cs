...
{
    public partial class ProcessService : BaseMaintainService<SProcess, ProcessDTO>, IProcessService
    {
        public ProcessService(IRepository<SProcess> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
