...
{
    public partial class FactoryService : BaseMaintainService<SFactory, FactoryDTO>, IFactoryService
    {
        public FactoryService(IRepository<SFactory> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
