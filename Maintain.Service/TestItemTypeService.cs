...
{
    public partial class TestItemTypeService : BaseMaintainService<STestItemType, STestItemTypeDTO>, ITestItemTypeService
    {
        public TestItemTypeService(
                                IRepository<STestItemType> rep,
                                IMapper mapper)
        : base(rep, mapper)
        {
        }
