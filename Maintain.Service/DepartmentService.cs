...
{
    public partial class DepartmentService : BaseMaintainService<SDepartment, DepartmentDTO>, IDepartmentService
    {
        public DepartmentService(IRepository<SDepartment> rep, IMapper mapper)
        : base(rep, mapper)
        {
        }
    }
