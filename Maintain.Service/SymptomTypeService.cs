...
{
    public partial class SymptomTypeService : BaseMaintainService<SSymptomType, SSymptomTypeDTO>, ISymptomTypeService
    {
        public SymptomTypeService(
                                IRepository<SSymptomType> rep,
                                IMapper mapper)
        : base(rep, mapper)
        {
        }
